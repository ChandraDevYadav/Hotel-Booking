...
const Payment = () => {
  ...
  return (
    <><div className="min-h-screen px-4 md:px-44">
      <p className="text-2xl font-bold my-6">Secure booking</p>
      <div className="flex justify-start items-center gap-4 px-4 py-8 border border-gray-400 rounded-md mb-6">
        <div>
          <img src="/cale.png" className="object-fill w-16 md:w-12 h-14 md:h-12" alt="" />
        </div>
        <div>
          <p className="text-md md:text-sm font-bold text-gray-800">Fully refundable before Sun, Dec 15, 11:59pm (property local time)</p>
          <p className="text-xs md:text-sm text-gray-600 mt-2">You can change or cancel this stay for a full refund if plans change. Because flexibility matters.</p>
        </div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-5 gap-0 md:gap-4 gap-y-4 md:gap-y-0">
        {/* Payment Form Section */}
        <div className="col-span-3">
          <div className="flex justify-between items-center gap-2 md:gap-0 bg-gray-800 px-4 py-4 rounded-md mb-6">
            <div>
              <img src="/seq.svg" className="w-8 md:w-12 h-8 md:h-12" alt="" />
            </div>
            <div>
              <p className="text-xs md:text-md font-medium md:font-bold text-white">Sign in or create an account to earn $2.70 in OneKeyCash™ after this trip.</p>
            </div>
            <div>
          ...
          <form className="space-y-4 bg-white shadow-md rounded-lg p-6">
            ...
            <div className="flex flex-col md:flex-row justify-start items-center gap-4 pr-4 md:pr-44">
            ...
            <div className="flex space-x-4 pr-4 md:pr-44">
              <div className="w-1/2">
            ...
            <div className="w-full pr-4 md:pr-44">
              <select name="" id="country" className="w-full border py-2 px-4 rounded">
              ...
              <div className="flex justify-start items-center mt-4">
                <input type="checkbox" />
                <label htmlFor="" className="text-xs md:text-sm ml-3">Receive text alerts about this trip. Message and data rates may apply.</label>
              </div>
            </div>
            {/* <div className="mr-44">
      <button
      ...
      >
        Pay Now
          ...
          <div className="mt-6 border border-gray-300 rounded-md px-4 py-8">
            ...
            <div className="flex flex-col md:flex-row justify-start items-center gap-6">
              <div className="flex justify-start w-full items-center gap-2 text-green-800">
                <FaCheck className="text-sm" />
                <p className="text-md">We use secure transmission</p>
              </div>
              <div className="flex justify-start items-center w-full gap-2 text-green-800">
                <FaCheck className="text-md" />
                <p className="text-md">We protect your personal information</p>
              </div>
            </div>
          ...
          <div className="mt-6 border border-gray-300 rounded-md px-4 py-8">
            <div>
              ...
              <div className="my-6">
                <ul>
                  <li className="flex justify-start items-center gap-4 md:gap-2 mb-2">
                    <MdCancel className="text-4xl md:text-xl" /> Cancellation and interruption protection up to $100,000 per plan
                    benefit-icon</li>
                  <li className="flex justify-start items-center gap-4 md:gap-2 mb-2"><FaRunning className="text-4xl md:text-xl" /> Emergency assistance and transportation up to $100,000 per plan
                    benefit-icon</li>
                  <li className="flex justify-start items-center gap-4 md:gap-2 mb-2"><FaHotel className="text-4xl md:text-xl" /> Material misrepresentation of advertised property up to $500 per plan
                    benefit-icon</li>
                  <li className="flex justify-start items-center gap-4 md:gap-2 mb-2"><FaClockRotateLeft className="text-2xl md:text-xl" /> Expenses due to travel delay up to $5,000 per plan
                    benefit-icon</li>
                  <li className="flex justify-start items-center gap-4 md:gap-2 mb-2"><FaHeartPulse className="text-xl md:text-xl" /> Medical expenses up to $100,000 per plan</li>
                </ul>
              </div>
              <Link to='' className="text-sm text-blue-600 font-medium">View Benifit Details</Link>
              <div className="flex justify-start items-center gap-4 md:gap-2 border border-gray-400 mt-6 w-full py-4 px-4 rounded-md">
              ...
              <div>
                ...
                <div className="flex justify-between items-center border border-gray-400 gap-2 w-full px-4 py-3 mt-4 bg-blue-50">
                  <div className="flex justify-start items-center">
                    <input type="checkbox" name="" id="" className="" />
                    <label htmlFor="" className="ml-4 text-sm font-bold">Yes, I want to add protection to my stay.</label>
                  </div>
                  <div>
                    <p className="text-md md:text-lg font-bold">$4.50</p>
                  ...
                  <div className="flex justify-start items-start gap-2 border-b border-gray-400 pb-4">
                    ...
                    <label htmlFor="" className="text-sm ml-2">
                      <div>
                        ...
                        <p className="text-xs mt-2">I understand by declining this coverage that I may be responsible for certain cancellation fees and delay expenses personally or through alternate coverage.</p>
                      </div>
                    </label>
                  </div>
              ...
              - Joel L, United States`
                ...
                <div>
                  <p className="flex justify-start items-center gap-2 text-xs text-blue-600 my-4">View plan details and disclosures <BsLayers /> </p>
        ...
        <div className="col-span-2">
          <div className="border border-gray-300 p-4 mb-6 rounded-md">
            {/* Carousel Section */}
      ...
      <div className="flex justify-center mt-6">
        <Link to='' className="text-center text-sm text-blue-600 flex justify-start items-center gap-2">[+] Tell us what you think <BsLayers /></Link>
      </div>
    </div>
    <div>
      <PaymentFooter/>
