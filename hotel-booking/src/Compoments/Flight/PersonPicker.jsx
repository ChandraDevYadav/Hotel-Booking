  ...
  return (
    <div className="flex items-center justify-center">
      ...
      <button
        ...
        className="pl-4 pr-14 py-1 w-full bg-white border border-black rounded-md shadow-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 flex justify-start items-center gap-3"
      >
        <FaUser/>
        <div className="text-start">
            <p className="text-xs">Travelers</p>
            <p className="">1 Travelers</p>
        </div>
      </button>
