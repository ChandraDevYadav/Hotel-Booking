    ...
    return (
        <div ref={dropdownRef} className="relative inline-block text-left w-full">
            ...
            <button
                ...
                className="flex justify-between items-center w-full px-4 bg-white font-medium text-gray-700 border border-black rounded-lg shadow-sm focus:outline-none"
            >
                <div className="">
                <span className="text-xs">{label}</span> <br />
                <span className="text-gray-500 text-sm mt-1">
                    {selectedTime === "Select Time" ? "Select Time" : selectedTime}
                </span>
                </div>
                <span className="">
                    <FaAngleDown />
