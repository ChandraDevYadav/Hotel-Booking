    ...
    <div className="">
      ...
      <div className="relative">
        <button
          ...
          className="w-full pl-4 pr-14 py-1 bg-white border border-black rounded-md shadow-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 flex justify-start items-center gap-3"
        >
          <LuCalendarDays />
          <div className="text-start">
            <p className="text-xs font-medium">Departing between</p>
