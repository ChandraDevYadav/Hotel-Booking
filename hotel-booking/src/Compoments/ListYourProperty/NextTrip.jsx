...
const NextTrip = () => {
    return (
        <div>
            <div>
                <h1 className='text-3xl font-semibold text-gray-800'>Ideas for your next trip</h1>
                <div className='grid grid-cols-6 gap-8 px-4 my-4 pb-6 border-b border-b-gray-300'>
