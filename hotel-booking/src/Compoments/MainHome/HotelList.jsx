...
const HotelList = () => {
  ...
  return (
    <div className="pb-8">
      <h1 className="text-sm font-medium text-blue-600 w-full md:w-[24%] border-b-[3px] px-2  border-blue-600 py-4">
        Explore a world of travel with StayEase
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 h-[250px] overflow-y-auto border-t">
        {/* Themes */}
        <div className="mt-4">
        ...
        <div>
          <h2 className="text-lg font-bold mb-2 mt-4">
            Top Destinations for Luxury Hotels
          </h2>
          <div className="space-y-2">
