    ...
    return (
        <div>
            <div className='relative pb-10 pt-2'>
                <div className='grid grid-cols-4 bg-gray-200 rounded-xl shadow'>
                    <div className='col-span-2 pl-10 pt-8'>
                        ...
                        <button className='bg-white text-blue-700 px-4 py-2 rounded-full border font-semibold border-gray-300'>Learn more</button>
                    </div>
