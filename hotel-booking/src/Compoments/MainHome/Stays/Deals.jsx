...
const Deals = () => {
  ...
  return (
    <div className="pt-6">
        <div className="flex justify-around items-center bg-gray-950 px-6 py-6 rounded-2xl my-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        {dealsData.map((deal, index) => (
          ...
          >
            <div className="col-span-2 pl-4 pt-4 bg-yellow-300 rounded-l-xl">
            <h2 className="text-md font-semibold text-gray-900">{deal.title}</h2>
