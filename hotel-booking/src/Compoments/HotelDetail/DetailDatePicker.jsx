  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="pl-4 pr-14 py-[7px] w-full bg-white border border-black rounded-md shadow-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 flex justify-start items-center gap-3"
      >
        <LuCalendarDays />
